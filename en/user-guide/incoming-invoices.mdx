...
For the full matching workflow, see [Bank sync](/user-guide/bank-sync).
...
For the email workflow, see [Email intelligence](/user-guide/email-intelligence).
