...
<Columns cols={2}>
  <Card title="Invoicing" href="/user-guide/invoicing" icon="file-text" cta="Open guide">
    Manage outgoing invoices and understand how linked emails support follow-up and payment tracking.
  </Card>
  <Card title="Incoming invoices" href="/user-guide/incoming-invoices" icon="folder" cta="Open guide">
