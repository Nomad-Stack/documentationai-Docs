...
Configure these fields in [Custom fields](/user-guide/custom-fields). When a product custom field is set to show in tables, it also becomes part of the `/items` list view.
